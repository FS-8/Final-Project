    ...
    <div className=" px-16">
      <div className="flex justify-between gap-2 ">
        <div className="self-center flex-col flex gap-2 text-hitam">
          <h1 className="text-7xl">Shoes World</h1>
          <h2>Temukan semua brand sepatu indonesia di sini</h2>
          <h3>Kami hanya menyediakan sepatu dengan kualitas terbaik, sehingga Anda dapat berjalan dengan nyaman dan bergaya sepanjang hari.</h3>
        ...
        <div className="bg-putih p-5 flex flex-col">
          ...
          <div className="flex gap-5 overflow-auto overflow-y-hidden">
            <img className="w-40 bg-white " src={sepatu} alt="" />
            <img className="w-40 bg-white " src={sepatu} alt="" />
            <img className="w-40 bg-white " src={sepatu} alt="" />
          </div>
        </div>
