    ...
    <div className=" px-16">
      <div className="flex justify-between gap-2 sm:flex-col">
        <div className="self-center flex-col flex gap-2 text-hitam">
          ...
          <h3 className="text-lg font-light">“Berjalan di Tanah Air dengan Gaya” - Menyuarakan kebanggaan kita terhadap produk lokal dan menunjukkan bahwa sepatu lokal Indonesia dapat bersaing dalam hal gaya dan kualitas.</h3>
          <button className="px-5 py-3 bg-ungu rounded-3xl self-start text-putih hover:bg-hitam transition ease-in-out duration-300">Explore Now</button>
        </div>
