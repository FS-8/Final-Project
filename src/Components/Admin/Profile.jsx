...
function Profile() {
  return (
    <div className="bg-ungu flex justify-center">
      <div className="mt-4 flex-col gap-3">
        <form className="border p-8 flex flex-col gap-3 mb-4 bg-putih">
          <strong className="text-white-700 font-medium mt">Form Profile</strong>
