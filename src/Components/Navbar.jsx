      ...
      <div className="bg-white top-0 fixed z-50 w-full">
        <nav className="px-16 flex justify-between py-3 align-middle sm:px-5">
          ...
          <div onClick={() => navigate("/")} className="flex gap-2">
            <img
              className="w-10"
              src="https://i.postimg.cc/3JKfM1yP/20231020-174836.png"
              alt="logo"
            />
          ...
          <form className="self-center sm:hidden">
            <div className="flex">
              <input
                className="border border-hitam rounded-md px-2 py-1 mt-0"
                type="text"
              />
          ...
          <div className="flex gap-2 text-white sm:hidden">
            <button className="px-5  bg-ungu rounded-3xl hover:bg-hitam transition ease-in-out duration-300">
              Register
            </button>
            <button className="px-5  bg-hitam rounded-3xl hover:bg-ungu transition ease-in-out duration-300">
              Login
            </button>
          </div>
          <button
            onClick={() => setIsNavOpen(!isNavOpen)}
            className="hidden text-hitam sm:block"
          >
          ...
          <div className="flex gap-5 sm:justify-around text-putih">
            ...
            <div className="relative">
              ...
              <div
                className={
                  isDivOpen
                    ? "absolute p-2 bg-black  rounded-md mt-2 border border-ungu"
                    : "hidden"
                }
              >
                <button className="hover:border border-putih p-1">
                  Aerostreet
                </button>
                <button className="hover:border border-putih p-1">
                  Compass
        ...
        <div
          className={
            !isNavOpen ? "hidden" : "bg-ungu right-0 p-2 text-putih z-10"
          }
        >
          {/* search */}
          <form className="self-center flex">
            <div className="flex w-full">
              <input
                className="border border-hitam rounded-md px-2 py-1 mt-0 w-full"
                type="text"
              />
          ...
          <div className="flex flex-col gap-2 mt-2">
            <button className="px-5 py-2 bg-hitam rounded-3xl hover:bg-ungu transition ease-in-out duration-300">
              Register
            </button>
            <button className="px-5 py-2 bg-hitam rounded-3xl hover:bg-ungu transition ease-in-out duration-300">
              Login
