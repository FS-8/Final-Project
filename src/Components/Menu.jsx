    ...
    <>
      <div className="flex flex-col justify-center my-5">
        ...
        <div className="flex flex-wrap p-5 justify-center gap-10 smrid:gap-2">
          <div onClick={() => navigate("/gender/pria")} className="relative  ">
          ...
          <div onClick={() => navigate("/gender/wanita")} className="relative w-60  smrid:w-40 overflow-hidden">
          ...
          <div onClick={() => navigate("/kategori/sport")} className="relative  ">
          ...
          <div onClick={() => navigate("/kategori/casual")} className="relative  ">
