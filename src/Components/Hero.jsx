    ...
    <div className=" px-16 smrid:px-0 mt-24 ">
      <div className="flex justify-between gap-2 smrid:flex-col smrid:text-center">
        <div className="self-center flex-col flex gap-2 smrid:gap-0 text-hitam smrid:hidden">
          <h1 className="text-7xl font-bold smrid:text-2xl smrid:mt-2">Shoes World</h1>
          <h2 className="text-5xl font-bold smrid:text-lg">Temukan semua brand sepatu indonesia di sini</h2>
          <h3 className="text-lg font-light smrid:text-smrid">
